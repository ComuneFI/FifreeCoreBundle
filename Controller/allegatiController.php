...
class allegatiController extends FiController {
  ...
  public function updateAction(Request $request, $id) {
    ...
    return $this->render($nomebundle . ':' . $controller . ':editiframe.html.twig', array(
                'entity' => $entity,
  ...
  public function newiframeAction(Request $request) {
    ...
    return $this->render($nomebundle . ':' . $controller . ':newiframe.html.twig', array(
                'nomecontroller' => $controller,
                'entity' => $entity,
                'form' => $form->createView(),
    ));
...
//    );
    ...
    return $this->render($nomebundle . ':' . $controller . ':popup.html.twig', array(
                //'entities' => $entities,
                'nomecontroller' => $controller,
                'testata' => $testata,
                'canread' => $canRead,
