...
class ResponseListener
{
    ...
    public function onKernelResponse(FilterResponseEvent $event)
    {
        $securityProtection = "default-src 'self' http://*.comune.fi.it http://*.comune.intranet https:;"
                ...
                . "img-src     'self' http://*.comune.fi.it http://*.comune.intranet http://a.tile.openstreetmap.org data: https: ;         object-src  'self' http://*.comune.fi.it http://*.comune.intranet ;         media-src   'self' http://*.comune.fi.it http://*.comune.intranet ;         child-src   'self' http://*.comune.fi.it http://*.comune.intranet https:;"
