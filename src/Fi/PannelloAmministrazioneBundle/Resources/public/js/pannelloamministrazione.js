...
function opendialogrisultato() {
    $("#risultato").dialog(
            {modal: true, maxHeight: 600, width: 800, dialogClass: "no-close",
                buttons: [
                    {
                        id: "closedialogbutton", name: "closedialogbutton", text: "Chiudi",
                        click: function () {
                            $(this).dialog("close");
                        }
                    }
            ...
            .dialog(
                    {
                        ...
                        buttons: {
                            "Si": {id: "yesdialogbutton", name: "yesdialogbutton", text: "Si", click: function () {
                                    defer.resolve("true");//this text 'true' can be anything. But for this usage, it should be true or false.
                                    $(this).dialog("close");
                                }
                            },
                            "No": {id: "nodialogbutton", name: "nodialogbutton", text: "No", click: function() {
