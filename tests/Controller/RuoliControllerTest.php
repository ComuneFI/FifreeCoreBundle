...
class RuoliControllerTest extends FifreeTest
{
    ...
    public function crudoperation($session, $page)
    {
        ...
        $page->fillField('fi_corebundle_ruolitype_ruolo', $descrizionetest1);
        $page->fillField('fi_corebundle_ruolitype_is_user', 1);
        ...
        $page->fillField('fi_corebundle_ruolitype_ruolo', $descrizionetest2);
